...
class _VideoScreenState extends State<VideoScreen> {
  ...
  void _fetchAllVideos() async {
    ...
    try {
      ...
      QuerySnapshot savedSnapshot = await FirebaseFirestore.instance.collection('saved_videos').get();
      QuerySnapshot funnySnapshot = await FirebaseFirestore.instance.collection('funny_videos').get();

      _allVideos = [...savedSnapshot.docs, ...funnySnapshot.docs]; // Merge data
